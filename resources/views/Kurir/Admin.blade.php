...
<body>
    ...
    <link rel="stylesheet" href="../css/Kurir/admin.css">
        ...
        <div class="container-admin flex-column">
            ...
            <div class="row menu-admin px-3">
                <div class="col-3 flex-column">
                    <center>
                        <div style="background-image: url('../images/icon-Kurir.svg');" class="box-icon"></div>

                        <div style="text-align: center;" class="text-menu mb-3">
                            <b>PENGIRIMAN</b>
                            <p>Pastikan setiap pengiriman telah terjadwal dengan baik</p>
                        </div>
                        <a style="width: 10vw;" href="MasterPengiriman.html" class="btn btn-orange"> Go </a>
                    </center>
                </div>
