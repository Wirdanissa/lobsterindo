        ...
        <div class="row" style="width: 100%">
            ...
            <div class="col-4 position-relative logo_bahasa">
                {{-- d-flex align-items-end" --}}
                    <img class="logo"  src="images/lobsterindoputih.png" alt="">
                <ul class="footer-links bahasa">
                    {{-- <li>&copy; 2023 Lobster Indo</li> --}}
                    <li ><button class="btn btn-primary">Indonesia</button>
                        <button class="btn btn-primary">English</button>
                        <button class="btn btn-primary">Mandarin</button></li>
                  </ul>
