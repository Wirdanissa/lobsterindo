      ...
      <div class="container mt-5 mb-5">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 ps-5">
            ...
            <a href="https://wa.me/+6281213408596" type="button"
              class="btn border-danger rounded-5 fw-bold ms-auto mb-5"
              style="width: 20vw; margin-left: 20px; color: #dc3545">HUBUNGI KAMI VIA WHATSAPP</a>
          </div>
        </div>
      </div>
    </section>
