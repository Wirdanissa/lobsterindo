        ...
        <div id="sidebar" class="col-md-10 d-md-block sidebar">
          <div class="position-sticky">
            ...
            <ul class="nav flex-column mt-3 ms-2">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link active" href="pemijahan.html"> Proses Pemijahan </a>
              </li>
              <li class="sidebar-item">
        ...
        <main class="col-md-4 ms-sm-5 col-lg-8">
            ...
            <section id="content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                    <main class="content">
                        <img src="../images/prosespemijahan.jpeg" alt="" style="height: auto; width: 100%; margin-top: 3rem;">
                        <h2 class="fw-bold mt-5">6. Proses Pemijahan</h2>
