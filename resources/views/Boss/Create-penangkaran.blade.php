...
<link rel="stylesheet" href="{{ asset('css/Boss/penangkaran.css') }}">
        ...
        <section>
        <form method="POST" action="{{ URL('/penangkaran') }}">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="p-4 mb-4 mt-5 rounded-4 box-form">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                            <textarea class="rounded-3 form-control border" id="lokasi_penangkaran" name="lokasi_penangkaran" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                    ...
                    <div class="row mb-5 justify-content-center">
                        ...
                        <a style="width: 15vw;" href="{{ URL('/penangkaran') }}" type="button" class="btn btn-orange">Kembali</a>
                        </div>
                        <div class="col-md-4 mb-3 d-flex justify-content-center">
                        <button style="width: 15vw;" type="submit" class="btn btn-orange">Add</button>
                        </div>
                    </div>
                    </div>
                </div>
