...
<link rel="stylesheet" href="{{ asset('css/Boss/admin.css') }}">
        ...
        <div class="container-admin flex-column">
            <div>
                ...
                <p class="admin-desc mt-2">Selamat Datang Boss, Terimakasih atas kerja kerasnya. Pastikan kualitas dan
                    kondisi perusahaan tetap memenuhi standar.</p>
            </div>
            <div class="row menu-admin px-3">
                ...
                <div class="col-3 flex-column">
                    <center>
                        <div style="background-image: url('{{ URL('images/icon-pembayaran.svg') }}');" class="box-icon"></div>

                        <div style="text-align: center;" class="text-menu mb-3">
                            <b>PEMBAYARAN</b>
                            <p>Informasi metode pembayaran tersedia</p>
                        </div>
                        <a style="width: 10vw;" href="{{ URL('/pembayaran') }}" class="btn btn-orange"> Go </a>
                    </center>
                </div>
                <div class="col-3 flex-column">
                    <center>
                        <div style="background-image: url('{{ URL('images/icon-Penangkaran.svg') }}');" class="box-icon"></div>

                        <div style="text-align: center;" class="text-menu mb-3">
                            <b>PENANGKARAN</b>
                            <p>Informasi Penangkaran yang telah terdaftar</p>
                        </div>
                        <a style="width: 10vw;" href="{{ URL('/penangkaran') }}" class="btn btn-orange"> Go </a>
                    </center>
                </div>
            </div>
        </div>
