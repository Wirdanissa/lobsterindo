      ...
      <div class="container text-center p-3 mt-5 mb-5">
        ...
        <div class="row">
          <div class="col-md-6 mx-auto m-4">
            <p class="text-center">
              industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but
              also the leap into
            </p>
          </div>
    ...
    <section id="content">
      <div class="container mt-5 mb-5">
        <div class="row align-items-center">
          <div class="col-md-6">
            <main class="content pe-5" style="padding: 1px">
              <h2 class="fw-bold">Habitat Lobster Air Tawar</h2>
    ...
    <section id="content">
      <div class="container mt-5 mb-5">
        <div class="row align-items-center">
          <div class="col-md-12">
            <main class="content">
              <h5>industry. Lorem Ipsum has been the industry's</h5>
              <p class="mt-4 mb-4">
                ...
                leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like
    ...
    <section id="content">
      <div class="container mt-5 mb-5">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 ps-5">
            <main class="content text-end mt-5">
              <h2 class="fw-bold">Pembesaran Lobster Air Tawar</h2>
              <p class="fw-bold">industry. Lorem Ipsum has been the industry's</p>
              <p class="mt-5 mb-5">
                industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,
                but also the leap into
