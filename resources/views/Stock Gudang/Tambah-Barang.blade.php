...
<link rel="stylesheet" href="{{ asset('css/Stock Gudang/master-stock.css') }}">
        ...
        <section>
            <form method="POST" action="{{ '/barang/'.$data->id.'/tambah' }}">
                @csrf
                @method('PUT')
                <div class="mb-5 rounded-5 box-create" style="width: 50%; margin: auto; margin-top: 7rem">
                    <div class="">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="text-center fs-4 fw-bold mt-4">Menambah Stock Barang</h1>
                                ...
                                <div class="mb-5 row d-flex align-items-center">
                                    ...
                                    <div style="display: inline-flex;" class="col-sm-8 d-flex align-items-center">
                                        <b class="me-2">+</b>
                                        <input type="number" name="berat" class="form-control" id="inputPassword">
                                    </div>
                                    <div class="col-sm-2">
                                        gram
                                    </div>
